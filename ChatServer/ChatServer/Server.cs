...
namespace ChatServer
{
    ...
    public partial class Server : Form
    {
        ...
        private void MysqlFirstTimeSetup()
        {
            ...
            string mySqlUser = "user"; // add your current user
            string mySqlPassword = "pass"; // add your current password
            string mySqlDatabase = "chatterbox"; // add your current database
        ...
        private void Server_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string mySqlServer = "localhost"; 
                string mySqlUser = "user"; // add your current user
                string mySqlPassword = "pass"; // add your current pass
                string mySqlDatabase = "chatterbox"; // add your current database
